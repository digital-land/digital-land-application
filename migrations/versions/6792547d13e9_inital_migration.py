...
def upgrade():
    ...
    sa.Column('start_date', sa.Date(), nullable=True),
    sa.Column('end_date', sa.Date(), nullable=True),
    sa.ForeignKeyConstraint(['dataset_id'], ['dataset.dataset'], name='fk_dataset_record'),
    sa.ForeignKeyConstraint(['organisation_id'], ['organisation.organisation'], name='fk_organisation_record'),
    sa.ForeignKeyConstraint(['owning_record_reference', 'owning_record_dataset'], ['record.reference', 'record.dataset_id'], name='fk_record_self_owning_record', ondelete='CASCADE'),
