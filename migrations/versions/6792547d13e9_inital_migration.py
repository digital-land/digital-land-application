...
Revision ID: 6792547d13e9
Revises:
Create Date: 2025-01-30 15:41:19.122087
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["category_reference"],
            ["category.reference"],
            name="fk_category_category_value",
        ),
    ...
    op.create_table(
        ...
        sa.Column("end_date", sa.Date(), nullable=True),
        sa.ForeignKeyConstraint(
            ["parent"], ["dataset.dataset"], name="fk_dataset_self_parent"
        ),
        sa.ForeignKeyConstraint(
            ["specification_id"],
            ["specification.specification"],
            name="fk_specification_dataset",
        ),
    ...
    op.create_table(
        ...
        sa.Column("end_date", sa.Date(), nullable=True),
        sa.ForeignKeyConstraint(
            ["category_reference"], ["category.reference"], name="fk_categoryـfield"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["dataset"], ["dataset.dataset"], name="fk_dataset_dataset_field"
        ),
        sa.ForeignKeyConstraint(
            ["field"], ["field.field"], name="fk_field_dataset_field"
        ),
    ...
    op.create_table(
        ...
        sa.Column("owning_record_reference", sa.Text(), nullable=True),
        sa.Column("owning_record_dataset", sa.Text(), nullable=True),
        sa.Column("entry_date", sa.Date(), nullable=False),
        sa.Column("start_date", sa.Date(), nullable=True),
        sa.Column("end_date", sa.Date(), nullable=True),
        sa.ForeignKeyConstraint(
            ["dataset_id"], ["dataset.dataset"], name="fk_dataset_record"
        ),
        sa.ForeignKeyConstraint(
            ["organisation_id"],
            ["organisation.organisation"],
            name="fk_organisation_record",
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.PrimaryKeyConstraint("reference", "dataset_id", name="pk_record"),
    )
